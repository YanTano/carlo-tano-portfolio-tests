...
class AssistantChat {
  ...
  async open() {
    ...
    /*
     * The Carlo Assistant floating button has an animation.
     *
     ...
     * the Carlo Assistant chat window must become visible.
     */
  ...
  async clearChat() {
    ...
    /*
     * Carlo Assistant's Clear Chat button can be affected by widget
  ...
  async clickSuggestion(text) {
    ...
    /*
     * Firefox can be affected by Carlo Assistant widget animations
  ...
  async clickVoiceInput() {
    ...
    if (!voiceInput) {
      ...
      throw new Error(
        'Carlo Assistant voice input button was not found. ' +
